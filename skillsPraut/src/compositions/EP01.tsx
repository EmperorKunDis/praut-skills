...
import { SpiralGalaxy } from "../components/backgrounds/SpiralGalaxy";
...
/** Small definition tooltip — appears top-center, doesn't obscure content. */
...
export const EP01: React.FC = () => {
  return (
    <>
      <PrautVideoFrame episodeNumber="01" episodeName="10 Mýtů o AI">
        ...
        <Sequence from={660} durationInFrames={90}>
          <FadeTransition>
            <ChapterCard
              number="01"
              title="AI je jenom bublina a nic to neumí"
              prefix="MÝTUS"
            />
          </FadeTransition>
        </Sequence>
        ...
        <Sequence from={4440} durationInFrames={90}>
          <MythBustedCard
            ...
            mythText="AI je jenom bublina a nic to neumí"
          />
        </Sequence>
        ...
        <Sequence from={8220} durationInFrames={90}>
          <MythBustedCard
            ...
            mythText="Stačí koupit AI produkt a lidi ho začnou používat"
          />
        </Sequence>
        ...
        <Sequence from={12210} durationInFrames={90}>
          <MythBustedCard
            ...
            mythText="AI je jen pro velké korporace s milionovými rozpočty"
          />
        </Sequence>
          ...
          <FadeTransition>
            ...
            >
              ...
              >
                ...
                skvělou práci. Ale NIKDY mu nedáte podepsat smlouvu nebo
                diagnózu bez kontroly šéfa.
              </p>
              <WebcamPlaceholder />
            </AbsoluteFill>
          </FadeTransition>
        ...
        <Sequence from={15690} durationInFrames={90}>
          <MythBustedCard
            ...
            mythText="AI vždy říká pravdu / AI jenom halucinuje"
          />
        </Sequence>
          ...
          <FadeTransition>
            ...
            >
              ...
              >
                ...
                &apos;rozumí&apos; matematice? Ne. Sleduje pravidla. AI je
                totéž, jen s jazykem místo čísel.
              </p>
              <WebcamPlaceholder />
            </AbsoluteFill>
          </FadeTransition>
        ...
        <Sequence from={18840} durationInFrames={90}>
          <MythBustedCard
            ...
            mythText="AI rozumí tomu co říká – myslí jako člověk"
          />
        </Sequence>
        ...
        <Sequence from={18930} durationInFrames={90}>
          <FadeTransition>
            <ChapterCard
              number="06"
              title="AI potřebuje vždy internet"
              prefix="MÝTUS"
            />
          </FadeTransition>
        </Sequence>
        ...
        <Sequence from={22020} durationInFrames={210}>
          <FadeTransition>
            ...
            >
              <AnalogyVisual
                left={{
                  label: "Laptop na chatě bez internetu",
                  icon: "laptop",
                }}
        ...
        <Sequence from={22230} durationInFrames={90}>
          <MythBustedCard
            ...
            mythText="AI potřebuje vždy internet"
          />
        </Sequence>
        ...
        <Sequence from={25620} durationInFrames={90}>
          <MythBustedCard
            ...
            mythText="Stačí zadat prompt a AI udělá vše perfektně napoprvé"
          />
        </Sequence>
        ...
        <Sequence from={29100} durationInFrames={90}>
          <MythBustedCard
            ...
            mythText="Implementace AI trvá měsíce nebo roky"
          />
        </Sequence>
            ...
            >
              ...
              >
                {[
                  ...
                  {
                    stat: "4×",
                    label: "vyšší selhání AI CS vs jiné use cases",
                  },
        ...
        <Sequence from={33840} durationInFrames={90}>
          <MythBustedCard
            ...
            mythText="AI chatbot = automaticky skvělý zákaznický servis"
          />
        </Sequence>
        ...
        <Sequence from={37620} durationInFrames={90}>
          <MythBustedCard
            ...
            mythText="AI je příliš složitá na pochopení pro běžného člověka"
          />
        </Sequence>
        ...
        <Sequence from={37710} durationInFrames={450}>
          <FadeTransition>
            <EndScreen
              thanks="AI není ani zázrak, ani podvod. Je to nástroj — záleží na tom, kdo ho drží."
              showNextFrame
            />
          </FadeTransition>
        </Sequence>
        ...
        {/* ═══ DEFINITION OVERLAYS ═══ */}
        <Sequence from={950} durationInFrames={90}>
          <DefOverlay
            term="ROI"
      ...
      <Sequence from={15} durationInFrames={585}>
        <AbsoluteFill
          style={{
            display: "flex",
            alignItems: "center",
        ...
        >
          <div
            style={{
              width: 1600,
              height: 900,
              border: `${frameTokens.borderWidth}px solid ${colors.blue[400]}`,
              borderRadius: 16,
              background: "#00FF00",
      ...
      <Sequence from={600} durationInFrames={60}>
        <AbsoluteFill style={{ zIndex: 52 }}>
          <IntroAnimation tagline="Profesionální automatizace" />
        </AbsoluteFill>
      </Sequence>
    </>
  );
